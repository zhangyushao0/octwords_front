...
class LoginReply extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoginReply', package: const $pb.PackageName(_omitMessageNames ? '' : 'login'), createEmptyInstance: create)
